...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-30 backdrop-blur-xl bg-slate-900/80 border-b border-white/10 shadow-lg shadow-cyan-900/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          >
            ...
            <div className="relative p-2 sm:p-2.5 rounded-lg border border-white/10 bg-slate-800/60 backdrop-blur-md group-hover:border-cyan-500/50 transition-all duration-300 group-hover:shadow-[0_0_20px_rgba(6,182,212,0.3)] group-hover:bg-slate-800/80">
              ...
              {navElements.map(
                (element) =>
                  element.isVisible && (
                    ...
                    ${
                      isActive
                        ? "text-cyan-300 bg-cyan-500/20 border border-cyan-500/50 shadow-[0_0_20px_rgba(6,182,212,0.3)]"
                        : "text-slate-300 hover:text-cyan-300 border border-transparent hover:border-white/10 hover:bg-slate-800/50"
                    }
                    /* STYLE FIX: Changed before:..-cyan-500/0 to /20 so glow is visible */
                    before:absolute before:inset-0 before:rounded-lg before:bg-linear-to-r before:from-cyan-500/20 before:via-purple-500/20 before:to-cyan-500/20 
                    ...
                    hover:shadow-[0_0_15px_rgba(6,182,212,0.2)] hover:scale-105`
                      }
                    >
                      <span className="relative z-10 flex items-center">
                        <span className="absolute left-0 -bottom-1 w-0 h-0.5 bg-linear-to-r from-cyan-400 to-purple-400 group-hover:w-full transition-all duration-300"></span>
                        {element.name}
                      </span>
                    </NavLink>
                  )
          ...
          <button
            ...
            className="md:hidden p-2 rounded-lg border border-white/10 bg-slate-800/60 backdrop-blur-sm text-cyan-400 hover:text-cyan-300 hover:border-cyan-500/50 hover:bg-slate-800/80 transition-all duration-300 hover:shadow-[0_0_15px_rgba(6,182,212,0.2)]"
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute top-20 left-0 right-0 bg-slate-900/90 backdrop-blur-xl border-b border-white/10 shadow-xl shadow-cyan-900/20 transition-all duration-300 ease-in-out ${
          isMobileMenuOpen
          ...
          {navElements.map(
            (element) =>
              element.isVisible && (
                ...
                after:absolute after:inset-0 after:rounded-lg after:bg-linear-to-r after:from-cyan-500/20 after:via-purple-500/20 after:to-cyan-500/20 
                after:opacity-0 hover:after:opacity-100 after:transition-opacity after:duration-300 after:blur-sm
                hover:shadow-[0_0_15px_rgba(6,182,212,0.2)] active:scale-95`
                  }
                >
                  <span className="relative z-10 flex items-center">
                    <span className="absolute left-0 -bottom-1 w-0 h-0.5 bg-linear-to-r from-cyan-400 to-purple-400 group-hover:w-full transition-all duration-300"></span>
