          ...
          <div className="relative bg-[#080f1e]/90 border border-cyan-900/50 backdrop-blur-xl p-1 shadow-2xl">
            ...
            <div className="flex justify-between items-center px-4 py-2 bg-[#050b14] border-b border-cyan-900/30 mb-6">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-mono text-cyan-500 tracking-[0.2em] uppercase">Reg_Protocol_V.1</span>
                </div>
            ...
            >
              ...
              <div className="text-center relative">
                ...
                <h1 className="text-3xl font-bold text-white mb-2 font-mono tracking-tight uppercase">
                  Create <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-blue-500">Account</span>
                </h1>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-1">
                  <Input
                    ...
                    disabled // Preserved existing logic
                    className="futuristic-input opacity-70 cursor-not-allowed"
                    {...register("userName", {
                      required: true,
                    })}
                  />
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className={`relative w-full py-4 text-sm font-bold font-mono uppercase tracking-widest transition-all duration-300 group overflow-hidden bg-transparent mt-2
